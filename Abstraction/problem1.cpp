...
// In the main function, we create instances of Circle and Rectangle and store their addresses in an array of pointers to Shape objects. We demonstrate abstraction by iterating through the array and calling the draw function through the pointers.
...
int main() {
    ...
    // Abstraction through base class pointers
